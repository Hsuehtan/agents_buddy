...
export const DEFAULT_OEM_BRAND: Readonly<OemBrandConfig> = Object.freeze({
  productName: 'AgentsBuddy',
  productShortName: 'AgentsBuddy',
  companyName: '模匠科技',
  descriptor: '企业私有化部署的数字员工平台',
  copyright: '© 模匠科技',
  documentTitle: '企业私有化部署的数字员工平台',
  logoUrl: '/AgentsBuddy.png?v=agentsbuddy-1',
  compactLogoUrl: '/AgentsBuddy.png?v=agentsbuddy-1',
  faviconUrl: '/favicon.ico?v=agentsbuddy-1',
  loginArtworkUrl: '',
  socialPreviewUrl: '',
  supportUrl: '',
  documentationUrl: '',
